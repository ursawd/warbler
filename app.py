...
def add_user_to_g():
    ...
    # CURR_USER_KEY = "curr_user" so if key is in session
    # retrieve user record from users table and place in g
...
def profile():
    ...
    return render_template("users/edit.html", form=form)  # templates/users/edit.html
